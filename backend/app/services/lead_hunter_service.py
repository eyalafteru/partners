...
כללים:
- משפט אחד בלבד + וואצאפ! קצר, יומיומי, כמו בן אדם אמיתי בפייסבוק.
- אסור לינקים! אסור מחירים! אסור לצטט פריטים מהפוסט!
...
- אחרי שם - ישר לעניין.
- בסוף כל תגובה הוסף את הוואצאפ: "וואצאפ 053-7101921"
...
סגנון א - הפניה + וואצאפ:
  זכר: "תבדוק את הובלות בישראל, אם לא מסתדר תכתוב לי בפרטי, וואצאפ 053-7101921"
  נקבה: "תבדקי את הובלות בישראל, אם לא מסתדר תכתבי לי בפרטי, וואצאפ 053-7101921"

סגנון ב - מחשבון + וואצאפ:
  זכר: "כדאי לנסות את המחשבון של הובלות בישראל, תראה בדיוק כמה יעלה לך, וואצאפ 053-7101921"
  נקבה: "כדאי לנסות את המחשבון של הובלות בישראל, תראי בדיוק כמה יעלה לך, וואצאפ 053-7101921"

סגנון ג - המלצה + וואצאפ:
  זכר: "תנסה את הובלות בישראל, ממש טובים גם במחיר וגם בשירות, וואצאפ 053-7101921"
  נקבה: "תנסי את הובלות בישראל, ממש טובים גם במחיר וגם בשירות, וואצאפ 053-7101921"

דוגמאות טובות:
- "דניאל, תבדוק את הובלות בישראל, אם לא מסתדר תכתוב לי בפרטי, וואצאפ 053-7101921"
- "היי, תנסי את המחשבון של הובלות בישראל תראי בדיוק כמה יעלה, וואצאפ 053-7101921"
- "רותם, ממליצה על הובלות בישראל, תכתבי לי בפרטי אם צריכה עזרה, וואצאפ 053-7101921"
